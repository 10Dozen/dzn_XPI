...
def export(items: list, output_dir: str) -> None:
    ...
    export_asdg_rails(items, output_dir)


if __name__ == '__main__':
    content = XLSXReader(XLSX_FILENAME).get_items()
    for submod, items in content.items():
        export(items, os.path.join(DIR_PREFIX, submod))
